...
public class newUser extends javax.swing.JFrame {
    ...
    public newUser(String userName, String userLevel, String email) {
        initComponents();
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        if (firstName.getText().isEmpty() || lastName.getText().isEmpty() || address.getText().isEmpty() || city.getText().isEmpty()
            ...
            if (!comboUserLevel.getSelectedItem().toString().equals("User Level")) {
                ...
                JOptionPane.showMessageDialog(this, "Please provide the user Level", "Error", JOptionPane.ERROR_MESSAGE);
            }
        }
