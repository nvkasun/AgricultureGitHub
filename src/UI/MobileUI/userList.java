...
public class userList extends javax.swing.JFrame {
    ...
    public userList(String userName, String userLevel, String email) {
        initComponents();
    ...
    private void initComponents() {
        ...
        search1.setText("Search by Fiest Name...");
        ...
        listUsers.setFont(new java.awt.Font("Segoe UI Semilight", 0, 14)); // NOI18N
        listUsers.setForeground(new java.awt.Color(153, 153, 153));
    ...
    private void search1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_search1KeyReleased
        if (!search1.getText().equalsIgnoreCase("")) {
            ...
            ListLoad(listUsers, searchUsers);
        }
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        userManageOptions d = new userManageOptions(username, userLevel, email);
        d.setVisible(true);
        this.hide();
        listUsers.removeAll();
        theUsers.removeAll(theUsers);
    ...
    private void deleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteMouseClicked
        ...
        if (confirm == 0) {
            if (userID.equals(" ") || userID.equals("Memeber")) {
                JOptionPane.showMessageDialog(this, "Please select a user to delete...", "Error", JOptionPane.ERROR_MESSAGE);

            } else {
                userNum = Integer.parseInt(userID);

                User user = theUsers.getMemberFromNumber(Integer.parseInt(userID)).firstElement();
    ...
    private void listUsersValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_listUsersValueChanged
        String idx = listUsers.getSelectedValue().toString();
        String[] parts = idx.split(" ");
        userID = parts[0];
    }//GEN-LAST:event_listUsersValueChanged

    private void updateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateMouseClicked
        if (!userID.equals("Member") || !userID.equals("")) {
            updateUser u = new updateUser(username, userLevel, email);
            u.setVisible(true);
            this.hide();
            listUsers.removeAll();
            theUsers.removeAll(theUsers);
            ...
            JOptionPane.showMessageDialog(this, "Please select a memeber to update...", "Error", JOptionPane.ERROR_MESSAGE);
     ...
     * @param searchList
     */
    public static void ListLoad(JList list, SetOfUsers searchList) {
        DefaultListModel listModel = new DefaultListModel();
        list.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        int i = 0;
        String data = "";
        if (searchList.size() != 0) {
            listModel.addElement("Member Number Member Name");
            for (User member : searchList) {
                data = member.getMemberNumber() + "     " + member.getName();
                i++;
