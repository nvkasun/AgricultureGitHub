 ...
 * @author Gihan
 */
public class farmManageOptions extends javax.swing.JFrame {

    /**
     * Creates new form farmManageOptions
     */
     ...
     * @param email
     */
    public farmManageOptions(String userName, String userLevel, String email) {
        initComponents();
    ...
    private void userMMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_userMMouseClicked
        newFarm n = new newFarm(userName, userLevel, email);
        n.setVisible(true);
        this.hide();
    ...
    private void SensorMMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SensorMMouseClicked
        farmList v = new farmList(userName, userLevel, email);
        v.setVisible(true);
        this.hide();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(farmManageOptions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new farmManageOptions().setVisible(true);
            }
        });
    }
