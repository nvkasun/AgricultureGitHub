 ...
 * @author Gihan
 */
public class farmList extends javax.swing.JFrame {
    ...
    public farmList(String userName, String userLevel, String email) {
        initComponents();
    ...
    private void initComponents() {
        ...
        listFarms = new javax.swing.JList();
        ...
        jLabel1.setText("Farm List");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 110, 120, -1));
        ...
        search1.setText("Search by Farmer Name...");
        ...
        listFarms.setFont(new java.awt.Font("Segoe UI Semilight", 0, 14)); // NOI18N
        listFarms.setForeground(new java.awt.Color(153, 153, 153));
        listFarms.setModel(new javax.swing.AbstractListModel() {
            String[] strings = { "Item 1", "Item 2", "Item 3", "Item 4", "Item 5" };
            public int getSize() { return strings.length; }
            public Object getElementAt(int i) { return strings[i]; }
        });
        listFarms.addListSelectionListener(new javax.swing.event.ListSelectionListener() {
            public void valueChanged(javax.swing.event.ListSelectionEvent evt) {
                listFarmsValueChanged(evt);
            }
        });
        jScrollPane1.setViewportView(listFarms);
    ...
    private void search1KeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_search1KeyReleased
        if (!search1.getText().equalsIgnoreCase("")) {
            searchfarm = thefarms.getfarmFromfarmerName(search1.getText());
            ListLoad(listFarms, searchfarm);
        }
    ...
    private void jButton1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton1MouseClicked
        farmManageOptions d = new farmManageOptions(username, userLevel, email);
        d.setVisible(true);
        this.hide();
        listFarms.removeAll();
        thefarms.removeAll(thefarms);
        searchfarm.removeAll(searchfarm);
    ...
    private void deleteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_deleteMouseClicked
        ...
        if (confirm == 0) {
            if (farmID.equals(" ") || farmID.equals("Farm")) {
                JOptionPane.showMessageDialog(this, "Please select a farm to delete...", "Error", JOptionPane.ERROR_MESSAGE);

            } else {
                farmNum = Integer.parseInt(farmID);

                farms specifiedFarm = thefarms.getfarmFromNumber(Integer.parseInt(farmID)).firstElement();
                boolean status = thefarms.removefarm(specifiedFarm);
                if (status) {
                    try {
                        Serialization.Serialize(thefarms, FILE_NAME_farms);
                    } catch (IOException ex) {
                        Logger.getLogger(farmList.class.getName()).log(Level.SEVERE, null, ex);
                    }
    ...
    private void listFarmsValueChanged(javax.swing.event.ListSelectionEvent evt) {//GEN-FIRST:event_listFarmsValueChanged
        String idx = listFarms.getSelectedValue().toString();
        String[] parts = idx.split(" ");
        farmID = parts[0];
    }//GEN-LAST:event_listFarmsValueChanged

    private void updateMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_updateMouseClicked
        if (!farmID.equals("Farm") || !farmID.equals("")) {
            updateFarm u = new updateFarm(username, userLevel, email);
            u.setVisible(true);
            this.hide();
            listFarms.removeAll();
            thefarms.removeAll(thefarms);
            ...
            JOptionPane.showMessageDialog(this, "Please select a farm to update...", "Error", JOptionPane.ERROR_MESSAGE);
     ...
     * @param searchList
     */
    private void ListLoad(JList list, SetOfFarm searchList) {
        DefaultListModel listModel = new DefaultListModel();
        list.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
        int i = 0;
        String data = "";
        if (searchList.size() != 0) {
            listModel.addElement("Farm Number Farmer Name Location");
            for (farms farm : searchList) {
                data = farm.getfarmNumber() + "     " + farm.getfarmername() + "     " + farm.getlocation();
                i++;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(farmList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
        //</editor-fold>
    ...
    private javax.swing.JList listFarms;
