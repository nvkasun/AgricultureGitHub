 ...
 * @author Kasun
 */
public class fertilizerManageOptions extends javax.swing.JFrame {
     ...
     *
     */
    public fertilizerManageOptions() {
        initComponents();
     ...
     * @param email
     */
    public fertilizerManageOptions(String userName, String userLevel, String email) {
        initComponents();
    ...
    private void initComponents() {
        ...
        SensorM.setText("Fertilizer List");
        ...
        userM.setText("Add New Fertilizer");
        ...
        jLabel4.setText("Manage Fertilizers");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 210, 240, 40));
    ...
    private void userMMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_userMMouseClicked
        newFertilizer n = new newFertilizer(userName, userLevel, email);
        n.setVisible(true);
        this.hide();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fertilizerManageOptions.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fertilizerManageOptions().setVisible(true);
            }
        });
    }
